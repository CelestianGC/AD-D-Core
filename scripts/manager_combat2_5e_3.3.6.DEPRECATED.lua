...
function onInit()
  ...
  -- this is used for the portrait/initiative rolled or not
  --setCustomRestStart(CharlistManagerADND.turnOffAllInitRolled);
...
-- function onRoundStart(nCurrent)
  ...
  -- ManagerCharlistADND.turnOffAllInitRolled();
-- end
